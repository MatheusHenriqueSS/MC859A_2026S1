...
GRAPHML_FILE = os.path.join(OUT_DIR, "mb_sample_graph.graphml.gz")
ARTIST_GRAPHML = os.path.join(OUT_DIR, "mb_artist_graph.graphml.gz")
DECADE_GRAPHML = os.path.join(OUT_DIR, "mb_decade_graph.graphml.gz")
COUNTRY_GRAPHML = os.path.join(OUT_DIR, "mb_country_graph.graphml.gz")
